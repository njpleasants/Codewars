//Codewars challenge Holiday VIII - Duty Free 8kyu
...
//P: Will be given the normal price of a bottle of whiskey, how much the whiskey is discounted for duty free, and how much your vacation costs.
//R: Return how many bottles of whiskey you would have to buy to cover the cost of your trip. Needs to be a whole number.
...
function dutyFree(normPrice, discount, hol) {
    const disPrice = normPrice / 100 * discount;
    let noOfBottles = hol / disPrice;
    if(noOfBottles <= hol) {
      let round_num = Math.floor(noOfBottles);
        return round_num;
    }
